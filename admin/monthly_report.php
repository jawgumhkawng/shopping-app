...
$fromMonth = date("Y-m-d",strtotime($currentMonth . '+ 1 day'));
$toMonth = date("Y-m-d",strtotime($currentMonth . '- 1 month'));
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered" id="my_table">
                    <h3 class="text-center text-primary">Monthly Report</h3>
                  <thead>
                  ...
                  <tbody>
                    <?php if ($ordResult) : ?>
                      <?php $i = 1; ?>
                      <?php foreach ($ordResult as  $value) : ?>
                          <?php
                          ...
                          <tr>
                            ...
                            <td class="text-center"><img src="../profile_image/<?= escape($resultUser[0]['image']) ?>" width="30"  height="30" style="border:1px solid gray !important;" class="rounded-circle shadow"></td>
