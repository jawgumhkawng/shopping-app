                ...
                <table class="table table-bordered" id="my_table">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th class="text-center" width="30%">Product_Name</th>                   
                      <th class="text-center" width="30%">Created_At</th>                   
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    <?php if ($BestSIResult) : ?>
                      <?php $i = 1; ?>
                      <?php foreach ($BestSIResult as  $value) : ?>
                          <?php
                            $stmtProd = $pdo->prepare("SELECT * FROM products WHERE id = ".$value['product_id']);
                            $stmtProd->execute();
                            $resultProd = $stmtProd->fetchAll();
                          ...
                          <tr>
                            ...
                            <td class="text-center"><img src="./images/<?= escape($resultProd[0]['image']) ?>" width="30"  height="30" style="border-radius:3px;" class=""></td>
                            <td class="text-center"> <?= escape($resultProd[0]['name'])?></td>    
                            <td class="text-center"> <?= escape(date('Y-m-d / h:i:s',strtotime($resultProd[0]['created_at'])))?></td>    
                          </tr>  
