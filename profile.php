...
<section class=" section_gap_bottom">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="contact_info">
                    ...
                    <div class="info_item">
                        ...
                        <h6><a href="#"><span class="__cf_email__"
                                    data-cfemail="9feceaefeff0edebdffcf0f3f0edf3f6fdb1fcf0f2"><?= $result['email'] ?></span></a>
                        </h6>
                        <p>Email</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="contact_info">
                    ...
                    <div class="info_item">
                        ...
                        <h6><a href="#"><span class="__cf_email__"
                                    data-cfemail="9feceaefeff0edebdffcf0f3f0edf3f6fdb1fcf0f2"><?= $result['created_at'] ?></span></a>
                        </h6>
                        <p>Created Date</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 ">
                <div class="contact_info ">
                    <img class="" src="./profile_image/<?= $result['image'] ?>" alt="" width="170px" height="170px"
